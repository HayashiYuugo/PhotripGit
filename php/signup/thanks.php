...
<link href="https://fonts.googleapis.com/css?family=Cinzel" rel="stylesheet"><!--googlefontのリンク-->
<link href="https://fonts.googleapis.com/css?family=Caveat" rel="stylesheet"><!--googlefontのリンク-->
<link rel="stylesheet" type="text/css" href="../../css/signup/thanks.css"><!--cssの相対リンク-->
...
<body>
	<div id="wrapper"><!--wrapperエリアの開始-->
		...
		<div id="subcontents"><!--subcontentsエリアの開始-->
			<p><a href="../login/login.php">ログイン</a>する</p>
